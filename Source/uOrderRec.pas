...
begin
  ...
  //  sDate := FormatDateTime('yyyy-MM-dd',dtp_Date.DateTime);
      try
        ...
        on E:Exception do
        begin
          WriteWorkLog('访问出错(getOrderID)',E.Message);
          Exit;
        end;
      end;
...
lab_loop:
        try
          ...
          begin
            ...
            WriteWorkLog('访问出错('+str+')',E.Message);
            Exit;
          end;
        end;
        if s <> '' then
  ...
  try
    ...
    begin
      ...
      try
        ...
        on E:Exception do
        begin
          WriteWorkLog('访问出错(getOrderQY)',E.Message);
          Exit;
        end;
      end;
      if High(Data) > -1 then
...
begin
  try
    ...
    try
      ...
      on E:Exception do
      begin
        WriteWorkLog('访问出错(getFXSJ)',E.Message);
        Exit;
      end;
    end;
    if s <> '' then
      ...
      begin
        ...
        begin
          try
            ...
            on E:Exception do
            begin
              WriteWorkLog('访问出错(setProductInfo)',E.Message);
              Exit;
            end;
          end;
          if iRec =0 then
        ...
        begin
          sSqlData := 'Update DO_FeedbackMakeOrder Set F_tiFKBZ=2,F_dFKRQ=getdate() where F_iSBID=%d';
          ExecQuery(sSqlData,[iSbid]);
...
begin
  ...
  //  sDate := FormatDateTime('yyyy-MM-dd',dtp_Date.DateTime);
      try
        ...
        on E:Exception do
        begin
          str := iif(iType = 0,'getGGCX','getGGCXD');
          WriteWorkLog('访问出错('+str+')',E.Message);
          Exit;
        end;
      end;
